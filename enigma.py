...
class Rotor:
    """Representa un rotor de la máquina Enigma"""
    ...
    def cifrar_adelante(self, letra):
        """Cifra una letra pasando por el rotor de derecha a izquierda"""
    ...
    def cifrar_atras(self, letra):
        """Cifra una letra en el camino de regreso"""
        indice = (self.alfabeto.index(letra) + self.posicion) % 26
...
class MaquinaEnigma:
    """Motor principal de la máquina Enigma"""
    ...
    def __init__(self, seleccion_rotores, posiciones_iniciales='AAA'):
        ...
        if len(seleccion_rotores) < 3 or len(seleccion_rotores) > 5:
            raise ValueError("Debe seleccionar entre 3 y 5 rotores")
    ...
    def _avanzar_rotores(self):
        """Avanza los rotores según la mecánica de Enigma"""
